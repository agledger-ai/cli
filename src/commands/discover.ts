  ...
  async run(): Promise<void> {
    ...
    result.quickstart = {
      ...
      steps: [
        ...
        { step: 3, action: 'Create a record', command: 'agledger api POST /v1/records --data \'{...}\'' },
        { step: 4, action: 'Submit a completion when done', command: 'agledger api POST /v1/records/{id}/completions --data \'{...}\'' },
      ],
    };
    ...
    result.docs = {
      ...
      narrative: '`agledger docs` (or `agledger docs --full`) returns the llms.txt prose narrative.',
    };
